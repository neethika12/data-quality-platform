...
const STEPS = [
  {
    ...
    route: '/',
    title: 'Welcome!',
    text: 'There are two ways to check your data here. This is Home — pick this one when you want to track ONE dataset over time: upload it once, then check back on it later to catch drift and changes.',
  },
  {
    target: 'nav-compare',
    route: '/',
    title: 'Or: Compare Two Files',
    text: 'Pick Compare instead when you just want to diff two specific files directly, right now — no history, no tracking, just "how does A differ from B?"',
  },
  {
    target: 'upload-card',
    route: '/',
    title: 'Step 1 — Upload',
    text: 'On Home: click here to upload a CSV, Excel, or Parquet file. This becomes your locked-in baseline.',
  },
  {
